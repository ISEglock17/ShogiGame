...
def process_shogi_json(client, json_data, base_name: str) -> tuple:
    ...
    # 1回のAPI呼び出しで全手を処理
    cleaned_lines, batch_memo = clean_comment_with_gemini(client, sente, gote, moves_comments)
...
def main():
    ...
    output_directory = './ProcessedComments_think'
    memo_directory = './ProcessedComments_think_memo'
