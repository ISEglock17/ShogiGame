...
【手順】  
1. コメントから削除すべき情報をルールに従って判断し、内部でその理由を考慮してください（削除理由は出力には含めないでください）。  
...
def main():
    ...
    output_directory = './ProcessedComments_reason_nodisplay'
    memo_directory = './ProcessedComments_reason_memo_nodisplay'
